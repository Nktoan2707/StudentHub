...
class SignUpAsCompanyPage extends StatefulWidget {
  static const String pageId = "/SignUpAsCompanyPage";

  const SignUpAsCompanyPage({super.key});

  @override
  State<SignUpAsCompanyPage> createState() => _SignUpAsCompanyPageState();
}

class _SignUpAsCompanyPageState extends State<SignUpAsCompanyPage> {
  @override
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<SignupBloc, SignupState>(
      ...
      builder: (context, state) {
        return TextField(
          key: const Key('signUpAsCompanyPage_usernameInput_textField'),
          onChanged: (fullName) {},
...
class _WorkEmailAddressInputState extends State<_WorkEmailAddressInput> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<SignupBloc, SignupState>(
      ...
      builder: (context, state) {
        return TextField(
          key: const Key('signUpAsCompanyPage_workEmailAddressInput_textField'),
          onChanged: (fullName) {},
          decoration: InputDecoration(
...
class _PasswordInputState extends State<_PasswordInput> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<SignupBloc, SignupState>(
      ...
      builder: (context, state) {
        return TextField(
          key: const Key('signUpAsCompanyPage_passwordInput_textField'),
    ...
    return BlocBuilder<SignupBloc, SignupState>(
      builder: (context, state) {
        return state.status.isInProgress
            ...
            : ElevatedButton(
                key: const Key('signUpAsCompanyPage_continue_raisedButton'),
